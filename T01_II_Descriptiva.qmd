...
description: "Medidas de posición, dispersión y forma para datos clínicos en fisioterapia. Cálculo e interpretación de media, mediana, varianza, desviación típica, percentiles, asimetría y curtosis con R."
...
date: "2026"
license: "CC BY 4.0"
keywords: "medidas de tendencia central, media, mediana, moda, medidas de dispersión, varianza, desviación típica, rango intercuartílico, asimetría, curtosis, visualización, histograma, boxplot, fisioterapia, bioestadística"
...
**Interpretación de la salida:** $n=8$, $\bar{x}=129.5°$, $s=3.3°$, $Me=129.5°$, $CV=2.5\%$ (muy homogéneo), $RIQ=3.75°$, asimetría $\approx 0$ (simétrica), Shapiro-Wilk $P > 0.05$ (compatible con normalidad).
...
3. **Estimación (T3):** IC 95%: $(126.2°, 133.8°)$ → ¿dónde está $\mu$?
