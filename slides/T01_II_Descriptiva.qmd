...
$$
s^2 = \frac{1}{n-1}\left[ \sum_{j=1}^{k} x_j^2 \cdot n_j
      - \frac{\left( \sum_{j=1}^{k} x_j \cdot n_j \right)^2}{n} \right]
$$
:::
...
$$
\begin{aligned}
s^2 &= \frac{1}{n-1}\left[\sum x_j^2 n_j - \frac{(\sum x_j n_j)^2}{n}\right] \\
    &= \frac{1}{59}\left[1{,}086{,}500 - \frac{8{,}050^2}{60}\right]
     = \frac{6{,}458}{59} = 109.5
\end{aligned}
$$
