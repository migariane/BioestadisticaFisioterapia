...
description: "Fundamentos de probabilidad para ciencias de la salud: axiomas, probabilidad condicionada, teorema de Bayes y variables aleatorias. Ejemplos clínicos con tests diagnósticos."
...
date: "2026"
license: "CC BY 4.0"
keywords: "probabilidad, axiomas de Kolmogorov, teorema de Bayes, probabilidad condicionada, variables aleatorias, diagramas de Venn, espacio muestral, fisioterapia, bioestadística"
...
::: {.callout-important}
A pesar de la alta sensibilidad (99%), el VPP es solo **16.7%** porque la **baja prevalencia** (1%) hace que los falsos positivos dominen.
:::

---

## Bayes — Visualización: Matriz de confusión
...
::: {.callout-warning}
**Interpretación:** $P(D \mid +) = 16.7\%$ — solo 1 de cada 6 positivos está realmente enfermo. El resto son **falsos positivos** debido a la baja prevalencia de la enfermedad (1%).
:::
